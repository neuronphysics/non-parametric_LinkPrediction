...
void inverseQ(gsl_matrix *Amat, int Asize) {
    gsl_matrix *old = gsl_matrix_calloc(Amat->size1, Amat->size2);
    gsl_matrix_memcpy(old, Amat);
...
int compute_inverse_Q_directly(int N,
                               int K,
                               gsl_matrix *Z,
                               double beta,
                               gsl_matrix *Q) {
