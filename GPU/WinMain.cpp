...
int main() {
    ...
    adjIn.open(R"(E:\clion projects\glfm_cuda_acc\dataSet\Adjacency_matrix_1500_7.txt)", ios::in);
    ...
    attributeIn.open(R"(E:\clion projects\glfm_cuda_acc\dataSet\Attribute_matrix_1500_7.txt)", ios::in);
